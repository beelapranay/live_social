        ...
        child: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => confessionMaking()));
          },
        ),
      ),
//      appBar: AppBar(
            ...
            return snapshot.hasData
                ? ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) =>
                        posts(context, snapshot.data.docs[index]))
                : Center(
                    child: Container(
...
//    );
  ...
  Widget posts(BuildContext context, DocumentSnapshot confess) {
    String url = confess.get('url');
    String title = confess.get('title');
    String confession = confess.get('confession');
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Column(children: <Widget>[
                  ...
                  AutoSizeText(
                    'Posted: ${timeago.format(confess.get('Timestamp').toDate())}',
